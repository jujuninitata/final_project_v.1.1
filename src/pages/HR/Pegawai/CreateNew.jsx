import { Button, Heading, Input, Select, Table, TableContainer, Tbody, Td, Tr, useToast, h1 } from '@chakra-ui/react';
...
import { getAllAgama,getAllUnit,getAllJabatan, getAllRole, getAllProvinsi, getAllKota,getAllKecamatan, getAllKelurahan} from '../../../services/masterservice';
          ...
          <Table variant='simple'>
            <Tbody>
                ...
                <Td>
                  <Select placeholder='Pilih Role' {...register('roleId', { required: true })}>
                    ...
                    <option value={2}>HR</option> */}
                     {listRole.map(item => (
                      <option key={item.id} value={item.roleId}>{item.roleName}</option>
                    ))}
                  </Select>
                </Td>
              </Tr>
              <Tr>
                ...
                <Td>
                  <Select placeholder='Pilih Unit Kerja' {...register('kodeunit', { required: true })}>
                    ...
                    {listUnit.map(item => (
                      <option key={item.id} value={item.kodeunit}>{item.namaunit}</option>
                    ))}
                  </Select>
                </Td>
              </Tr>
                ...
                <Td>
                  <Select placeholder='Pilih Jabatan' {...register('jabatan', { required: true })}>
                    ...
                    {listJabatan.map(item => (
                      <option key={item.id} value={item.kodejabatan}>{item.namajabatan}</option>
                    ))}
                  </Select>
                </Td>
              </Tr>
              <Tr>
                ...
                <Td>:</Td>
                <Td>
                  <Input type='textarea' {...register('alamat', { required: true })} />
                </Td>
              </Tr>
              ...
              <Tr>
                ...
                <Td>:</Td>
                <Td>
                  <Select placeholder='Pilih Provinsi' {...register('kodeprovinsi', { required: true })}>
                   {listProvinsi.map(item => (
                      <option key={item.id} value={item.kodeprovinsi}>{item.provinsi}</option>
                    ))}
                  </Select>
                </Td>
              </Tr>
              <Tr>
                ...
                <Td>:</Td>
                <Td>
                  <Select placeholder='Pilih Kota' {...register('kodekota', { required: true })}>
                   {listKota.map(item => (
                      <option key={item.id} value={item.kodekota}>{item.kota}</option>
                    ))}
                  </Select>
                </Td>
              </Tr>
              <Tr>
                ...
                <Td>:</Td>
                <Td>
                  <Select placeholder='Pilih Kecamatan' {...register('kodekecamatan', { required: true })}>
                   {listKecamatan.map(item => (
                      <option key={item.id} value={item.kodekecamatan}>{item.kecamatan}</option>
                    ))}
                  </Select>
                </Td>
              </Tr>
              <Tr>
                ...
                <Td>:</Td>
                <Td>
                  <Select placeholder='Pilih Kelurahan' {...register('kodekelurahan', { required: true })}>
                   {listKelurahan.map(item => (
                      <option key={item.id} value={item.kodekelurahan}>{item.kelurahan}</option>
                    ))}
                  </Select>
                </Td>
              </Tr>
              <Tr>
                ...
                <Td>:</Td>
                <Td>
                  <Input type='Number' {...register('rt', { required: true })} />
                </Td>
              </Tr>
              <Tr>
                <Td>RW</Td>
                <Td>:</Td>
                <Td>
                  <Input type='Number' {...register('rw', { required: true })} />
                </Td>
              </Tr>
              <Tr>
                <Td>Kode Pos</Td>
                <Td>:</Td>
                <Td>
                  <Input type='Number' {...register('kodepos', { required: true })} />
                </Td>
              </Tr>
            </Tbody>
          </Table>
