...
const tambahkecamatan = async (req, res) =>
{
    ...
    const resAdd = await db.kecamatan.create({kodekecamatan,kodekota,kecamatan,status});
    return res.status(201).json({
...
const tambahkelurahan = async (req, res) =>
{
    ...
    const resAdd = await db.kelurahan.create({kodekelurahan,kodekecamatan,kelurahan,status});
    return res.status(201).json({
